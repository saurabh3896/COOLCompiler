...
public class ClassTable {
	...
	public ClassTable() {
		...
		ol.put("copy", new AST.method("copy", new ArrayList<AST.formal>(), "SELF_TYPE", new AST.no_expr(0), 0));
	...
	boolean conforms(String current, String a, String b) {
		if(a.equals("SELF_TYPE"))
			a = current;
		if(b.equals("SELF_TYPE"))
			b = current;
		if(a.equals(b))
			return true;
		else {
			...
			else return conforms(current, a, b);
		}
	}
